        ...
        [ -- Add font imports
          Html.node "head"
            ...
            [ Html.node "link"
                ...
                , Attr.attribute "href" "https://fonts.googleapis.com/css?family=Inconsolata"
                ]
                []
            , Html.node "link"
                [ Attr.attribute "rel" "stylesheet"
                , Attr.attribute "href" "https://fonts.googleapis.com/css?family=Quicksand"
                ]
                []
            , Html.node "link"
                [ Attr.attribute "rel" "stylesheet"
                , Attr.attribute "href" "https://pattern.kivan-works.com/fonts/kredit.css"
                ]
                []
            ]
        , Html.div
            ...
            , Attr.style "background" "linear-gradient(125deg, #fbd7e5, #bdf4fa)"
            ]
            [ Html.div
                [ Attr.class "floating"
                , Attr.style "font-family" "Inconsolata"
                , Attr.style "margin" "auto"
                , Attr.style "width" "453px"
                , Attr.style "height" "280px"
                , Attr.style "box-shadow" "-20px 14px 54px rgba(0, 0, 0, 0.55)"
                , Attr.style "font-size" "18px"
                , Attr.style "border-radius" "8px"
                , Attr.style "transform-style" "preserve-3d"
                , Attr.style "transform-origin" "50% 50%"
                , Attr.style "background" "linear-gradient(145deg, #4684c1, #343174)"
                , Attr.style "transform" "rotateX(17deg) rotateY(18deg)"
                ...
                [ -- Thickness layers for 3D effect
                  Html.div
                    ...
                    , Attr.style "background" "linear-gradient(145deg, #4684c1, #343174)"
                    , Attr.style "transform" "translateZ(-4px)"
                    ]
                    []
                , Html.div
                    [ Attr.style "width" "453px"
                    ...
                    , Attr.style "position" "absolute"
                    , Attr.style "background" "linear-gradient(145deg, #4684c1, #343174)"
                    , Attr.style "transform" "translateZ(-8px)"
                    ]
                    []
                , Html.div
                    [ Attr.style "width" "453px"
                    ...
                    , Attr.style "position" "absolute"
                    , Attr.style "background" "linear-gradient(145deg, #4684c1, #343174)"
                    , Attr.style "transform" "translateZ(-11px)"
                    ]
                    []

                -- Floating text that appears on hover
                , Html.div
                    [ Attr.style "font-family" "Quicksand"
                    , Attr.style "font-weight" "bold"
                    , Attr.style "content" "Keep Moving Your Mouse!"
                    , Attr.style "width" "100%"
                    , Attr.style "text-align" "center"
                    , Attr.style "font-size" "2rem"
                    , Attr.style "position" "absolute"
                    , Attr.style "top" "-70px"
                    , Attr.style "background" "-webkit-linear-gradient(145deg, #4684c1, #343174)"
                ...
                -- Card body
                , Html.div
                    [ Attr.style "padding" "0.75rem 1.75rem"
                    , Attr.style "position" "relative"
                    ...
                    [ -- PayPal center logo
                      Html.div
                        ...
                        , Attr.style "top" "20px"
                        , Attr.style "left" "50%"
                        , Attr.style "transform" "translateZ(5px) translateX(-75px)"
                        , Attr.style "margin-left" "-75px"
                        , Attr.style "z-index" "1"
                        , Attr.style "filter" "drop-shadow(-6.4px 6.2px 8px rgba(0, 0, 0, 0.6))"
                    ...
                    , Html.div
                        ...
                        , Attr.style "transform" "translateZ(30px)"
                        , Attr.style "text-shadow" "0 0 5px rgba(0, 0, 0, 0.2)"
                        , Attr.style "margin" "0"
                    ...
                    -- Chip
                    , Html.div
                        [ Attr.style "margin-top" "17px"
                        , Attr.style "margin-left" "-1px"
                        , Attr.style "height" "70px"
                        , Attr.style "width" "80px"
                        , Attr.style "filter" "drop-shadow(-6.4px 6.2px 8px rgba(0, 0, 0, 0.6))"
                        , Attr.style "transform" "translateZ(25px)"
                        , Attr.style "background-repeat" "no-repeat"
                    ...
                    -- Card number
                    , Html.div
                        [ Attr.style "transform" "translateZ(40px)"
                        , Attr.style "font-family" "kredit-front"
                        , Attr.style "font-weight" "bold"
                        ...
                        , Attr.style "text-shadow" "-9px 8.7px 6px rgba(0, 0, 0, 0.8)"
                    ...
                    , Html.div
                        [ Attr.style "position" "absolute"
                        , Attr.style "bottom" "56px"
                        , Attr.style "color" "#fff"
                        , Attr.style "font-size" "0.58rem"
                        , Attr.style "left" "146px"
                        , Attr.style "text-shadow" "-9px 8.7px 6px rgba(0, 0, 0, 0.8)"
                        , Attr.style "transform" "translateZ(30px)"
                        ]
                        [ Html.text "VALID"
                    ...
                    , Html.div
                        ...
                        , Attr.style "color" "#fff"
                        , Attr.style "text-shadow" "-9px 8.7px 6px rgba(0, 0, 0, 0.8)"
                        , Attr.style "bottom" "54px"
                        , Attr.style "left" "180px"
                        , Attr.style "z-index" "20"
                        , Attr.style "transform" "translateZ(30px)"
                    ...
                    , Html.div
                        ...
                        , Attr.style "z-index" "20"
                        , Attr.style "letter-spacing" "2px"
                        , Attr.style "transform" "translateZ(50px)"
                        ]
                        [ Html.text "JOHN DOE" ]

                    -- Mastercard icon
                    , Html.div
                        [ Attr.style "height" "85px"
