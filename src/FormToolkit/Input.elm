...
mapIdentifier func (Input tree) =
    Input
        (Tree.mapValues
            (\input ->
                Internal.mapIdentifier func input
            )
            tree
        )
...
type alias HtmlAttributes id msg =
    ...
    , errorToHtmlMap : Maybe id -> Error -> Html msg
...
{-| TODO
-}
errorToHtmlMap : (Maybe id -> Error -> Html msg) -> HtmlAttribute id msg
